...
if __name__ == "__main__":
    ...
    print(f"w_0        = {w_s[-1]:.4f}")
    print(f"rho_Lambda = {coeff / L_s[-1]**2 * rho_crit:.4e} kg/m^3")
    ...
    ax.set_title('Modelo CRT v9.1 — Ciclo de Recoherencia Toroidal')
    ax.legend();  ax.grid(True, alpha=0.3)
    plt.tight_layout()
    
    # Save the plot
    output_path = 'img/wz_crt_v91.png'
